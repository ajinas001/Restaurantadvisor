...
function Bg_viewhoteldetails() {
    const [item, setItem] = useState({});

    console.log(item);

    const itemId = localStorage.getItem('Restaurant_id')
    console.log("restid", itemId);


    useEffect(() => {
        axios.get(`http://localhost:4001/save/view-hotel/${itemId}`)
            .then((res) => {
    ...
    return (
        <>
            ...
            <div className='col-lg-4 ' id='bg-mra-div21'>
                ...
                <>
                  <h2 className='p-5 text-center'>Admin will soon verify and accept your details </h2>
                  
                  <h2 className='p-5 text-center'>Thank you!!</h2>
...
export default Bg_viewhoteldetails